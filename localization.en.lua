...
SMARTBUFF_SHAMAN[2] = {"Water Shield", 10, SMARTBUFF_CONST_SELF};
SMARTBUFF_SHAMAN[3] = {"Earth Shield", 10, SMARTBUFF_CONST_SELF};
SMARTBUFF_SHAMAN[4] = {"Rockbiter Weapon", 5, SMARTBUFF_CONST_WEAPON};
SMARTBUFF_SHAMAN[5] = {"Frostbrand Weapon", 5, SMARTBUFF_CONST_WEAPON};
SMARTBUFF_SHAMAN[6] = {"Flametongue Weapon", 5, SMARTBUFF_CONST_WEAPON};
SMARTBUFF_SHAMAN[7] = {"Windfury Weapon", 5, SMARTBUFF_CONST_WEAPON};
SMARTBUFF_SHAMAN[8] = {"Water Breathing", 10, SMARTBUFF_CONST_GROUP, {22}};
